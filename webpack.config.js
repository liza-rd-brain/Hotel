...
const common = {
  entry: {
    ...
    roomDetails:
      PATHS.source + "/pages/website_pages/roomDetails/roomDetails.js",
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      filename: "roomDetails/index.html",
      chunks: ["roomDetails"],
      template:
        PATHS.source + "/pages/website_pages/roomDetails/roomDetails.pug"
    }),
    new HtmlWebpackPlugin({
